...
/*convierte a la base indicada*/
	ldr	r3, [fp, #-8] /*punto flotante*/
	ldr	r1, [fp, #-16] /*punto flotante*/
	mov	r0, r3   
	bl	__aeabi_idivmod
	mov	r3, r1
	mov	r2, r3
...
.L4:
	...
	.align	2
.LC1:
	.ascii	"Ingrese la base a la que desea convertir el numero anterior(entre 2 y 30): \000"
	.align	2
.LC2:
	.ascii	"%i\000"
	.align	2
...
.L10:
	...
	.align	2
.LC4:
	.ascii	"Ingrese el numero decimal mayor a 0: \000"
	.text
	.align	2
